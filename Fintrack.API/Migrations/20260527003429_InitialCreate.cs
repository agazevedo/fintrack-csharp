        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TsCreated = table.Column<DateTime>(type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BudgetItems_UserId_CategoryId_Description",
                table: "BudgetItems",
                columns: new[] { "UserId", "CategoryId", "Description" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Expenses_BudgetItemId_Date",
                table: "Expenses",
                columns: new[] { "BudgetItemId", "Date" },
                unique: true);
        }
